...
<link rel="stylesheet" type="text/css" href="css/styles.css"/>
   ...
   <p>Choose fund to buy: </p><br>
   <form method="POST" action="#">
   
		<table border="2" class="accountTable" align="center">
			<tr>
				<th width="100">Fund Name</th>
				<th width="100">NAV (Per unit)<br>as on today</th>
				<th width="100">Profit %<br>(over the last month)</th>
				<th width="100"></th>
			</tr>
			<tr>
				...
				<td align="center"><a href="BuyFundDetail.html">Buy</a></td>
			</tr>
			<tr>
