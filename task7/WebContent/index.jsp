...
<link rel="stylesheet" type="text/css" href="css/styles.css"/>
   ...
   <form action="">
   Username: <input type="text" name="cusername" id="cusername" />
   Password: <input type="password" name="cpassword" id="cpassword" />
   <input type="submit" name="clogin" value="Login" class="button"/>
   </form>
   </section>
   ...
   <form action="">
   Username: <input type="text" name="eusername" id="eusername" />
   Password: <input type="password" name="epassword" id="epassword" />
